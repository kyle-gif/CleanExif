...
const Tabs = ({ activeTab, onChangeTab }) => {
  return (
    <div className="flex gap-2 bg-leica-darkgray p-1 rounded-lg border border-leica-gray w-full max-w-md mx-auto mb-6">
      ...
      <button 
        className={`flex-1 py-2 text-sm font-medium rounded transition-all duration-200 ${activeTab === 'view' ? 'bg-leica-gray text-white shadow' : 'text-leica-lightgray hover:text-white'}`}
